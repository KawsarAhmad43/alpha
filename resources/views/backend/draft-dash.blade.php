...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4 px-5">
            {{-- greeting --}}
            {{-- @include('backend.partials.optional.greeting') --}}
            <hr class="my-0">

            {{-- boxes --}}
            @include('backend.partials.boxes')
            {{-- swiper --}}
            {{-- @include('backend.partials.optional.swiper') --}}

            <div class="row my-4">
                @include('backend.partials.basetable')
            </div>

            {{-- <div class="row my-4">
                @include('backend.partials.optional.barchart')
                @include('backend.partials.basetable')
            </div> --}}

            {{-- overview --}}
            {{-- @include('backend.partials.optional.overview') --}}
